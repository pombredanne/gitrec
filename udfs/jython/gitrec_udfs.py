...
@outputSchema("valuation: (specific_interest: double, general_interest: double, graph_score: double)")
...
@outputSchema("scaled_scores: (specific_interest: double, general_interest: double, graph_score: double)")
def scale_ui_scores(specific_interest, general_interest, graph_score):
